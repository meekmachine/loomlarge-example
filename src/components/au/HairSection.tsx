...
const HairSection = memo(function HairSection({ disabled = false, defaultExpanded = false }: HairSectionProps) {
  ...
  // NOTE: We intentionally do NOT dispose the HairService on unmount.
  // The physics simulation should continue running even when the drawer is closed.
  // The HairService will be garbage collected when the engine is disposed.
